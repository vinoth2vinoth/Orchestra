...
async function run() {
    ...
    try {
        const task = `Calculate the total cost of a project with 3 independent phases: Phase A costs $500. Phase B costs double of Phase A. Phase C costs $300 + Phase B. Determine the final cost. (Plan should have 3 independent tasks to calculate A, B, and C, and Manager should sum them.)`;
